...
- [Agent Gateway](https://api-catalog-three.vercel.app) - Unified API gateway providing 40+ services for AI agents — web scraping, screenshots, code execution, crypto prices, agent memory, file storage, and more. Free tier with 200 credits, no signup.
